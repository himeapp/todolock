...
enum LegalDoc {
    ...
    static let terms: [Section] = [
        ...
        애플리케이션은 서비스 제공을 위해 잠금 설정·과업 기록 등을 귀하의 기기에 저장·처리합니다. 휴대전화 및 애플리케이션 접근의 보안 유지는 귀하의 책임입니다. 공식 운영체제의 제한을 제거하는 탈옥(jailbreak)·루팅(rooting)은 보안을 약화시키고 애플리케이션이 정상 동작하지 않게 할 수 있으므로 권장하지 않습니다.
        """),
    ...
    static let privacy: [Section] = [
        ...
        • 사진 인증 과업으로 촬영·선택한 사진은 기기 안에서만 검수되며 외부로 전송·저장되지 않습니다.
